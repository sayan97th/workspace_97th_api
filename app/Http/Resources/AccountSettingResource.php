...
class AccountSettingResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'default_date_format' => $this->default_date_format ?? 'long',
            'default_time_format' => $this->default_time_format ?? '12',
            'default_first_day_of_week' => $this->default_first_day_of_week ?? 'sunday',

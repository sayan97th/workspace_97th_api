...
class NotificationPreferenceController extends Controller
{
    ...
    public function update(UpdateNotificationPreferencesRequest $request): JsonResponse
    {
        ...
        foreach (['desktop_notifications_enabled', 'notification_sound_enabled', 'tab_badge_enabled', 'auto_follow_enabled', 'quiet_hours_enabled', 'quiet_hours_start', 'quiet_hours_end', 'email_digest_frequency'] as $field) {

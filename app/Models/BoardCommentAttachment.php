...
/**
 * A file uploaded alongside a {@link BoardComment}, stored on the `public`
 * disk under `board-discussion-attachments/{board_id}/`, the same
...
class BoardCommentAttachment extends Model
{
    use HasFactory;

@php
    $email_title = "{$inviter_name} invited you to join 97th Floor";
    $email_preview = "{$inviter_name} would like you to join the account as a {$role_label}.";
...
<x-emails.layout :title="$email_title" :preview="$email_preview">
    <div class="email-padding" style="padding:32px 32px 28px;">
        <h1 class="email-heading" style="margin:0 0 12px; font-size:21px; line-height:1.35; color:#111827;">
            You're invited to join 97th Floor
        </h1>
        ...
        <div style="margin:28px 0;">
            <x-emails.button :href="$accept_url">Join 97th Floor</x-emails.button>
        </div>
